...
func _on_frozen_turtle_boss_health_changed(new_health: Variant, new_min_health: Variant, new_max_health: Variant) -> void:
	self.value=new_health
	self.max_health=new_max_health
	self.min_health=new_min_health
	self.min_value=new_min_health
...
func _on_wraith_health_changed(new_health: Variant, new_min_health: Variant, new_max_health: Variant) -> void:
	self.value=new_health
	self.max_health=new_max_health
	self.min_health=new_min_health
	self.min_value=new_min_health
...
func _on_pixy_health_changed(new_health: Variant, new_min_health: Variant, new_max_health: Variant) -> void:
	self.value=new_health
	self.max_health=new_max_health
	self.min_health=new_min_health
	self.min_value=new_min_health
...
func _on_lava_slimer_health_changed(new_health: Variant, new_min_health: Variant, new_max_health: Variant) -> void:
	self.value=new_health
	self.max_health=new_max_health
	self.min_health=new_min_health
	self.min_value=new_min_health
...
func _on_dragon_health_changed(new_health: Variant, new_min_health: Variant, new_max_health: Variant) -> void:
	self.value=new_health
	self.max_health=new_max_health
	self.min_health=new_min_health
	self.min_value=new_min_health
